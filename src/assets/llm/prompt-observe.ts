...
{
    "interpretation": "Your understanding of the visual design in the chart, e.g., what type is the chart, what is the data, what is the message, what is the design, etc."
    "data": "the retrieved data formatted in CSV"
    "layeredSvg": "<svg>...</svg>",
}`

    return [{
        role: "system",
        content: OBSERVE_SYSTEM_PROMPT
    },
    {
        role: "user",
        content: [
...
const observeFormat = zodResponseFormat(z.object({
    analysis: z.string(),
    dataSchema: z.string(),
    layeredSvg: z.string(),
